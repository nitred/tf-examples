...
# conv1 layer
W_conv1 = weight_variable([5, 5, 1, 32])  # patch 5x5 and 1 channel, 32 filters = 32 output activations
b_conv1 = bias_variable([32])
h_conv1 = tf.nn.relu(conv2d(x_image, W_conv1) + b_conv1)  # output size 28x28x32
h_pool1 = max_pool_2x2(h_conv1)  # 14 x 14 x 32

# conv2 layer
W_conv2 = weight_variable([5, 5, 32, 64])  # 5 x 5 filter size, 32 channels from prev layer, 64 output activation
